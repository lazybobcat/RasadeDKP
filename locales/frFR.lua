...
if L then
    ...
    L["ADDON_MOTD"] = "Hey, merci d'utiliser " ..
        addonName ..
        "! Entre |cffffd700/rdkp|r pour ouvrir le menu et |cffffd700/loot <link de l'objet>|r pour ouvrir les paris sur un objet.";
    L["DATE_FORMAT"] = "%d/%m/%y";
    ...
    L["UI_PLAYER_DETAILS_STATS"] = function(earned, spent)
        return "Statistiques : |cffC9221C" ..
            spent .. " dkp dépensés|r et |cff2BC85A" .. earned .. " dkp gagnés|r"
    end;
    ...
    L["UI_AUCTIONSWINDOW_HEADER_QUANTITY"] = function(qty, remaining)
        return "Quantité de cet item à distribuer : " ..
            remaining .. "/" .. qty
    end;
    ...
    L["UI_RESET_DB_CONFIRM"] = "Êtes-vous sûr de vouloir réinitialiser la base de données des DKP ?";
    L["UI_RESET_DB_CONFIRM_YES"] = "Oui";
    L["UI_RESET_DB_CONFIRM_NO"] = "Non";
    ...
    L["RL_MESSAGE_RAID_PARTICIPATION"] = function(dkp)
        return "Tous les joueurs ont reçu " ..
            dkp .. " pour leur participation au raid"
    end;
    ...
    L["DEFAULT_PLAYER_UNKNOWN_MESSAGE"] =
    "T'es qui toi ? T'es pas enregistré, tu n'as pas de DKP, fais '!dkp' dans le chat et préviens moi pour que je t'ajoute";
    L["DEFAULT_DKP_UNKNOWN_MESSAGE"] =
    "L'IA super intelligente développée par Tzinntch n'a pas trouvé de montant de DKP dans ton message. Envoie juste le nombre stp.";
    L["DEFAULT_BID_PLACED_MESSAGE"] = function(dkp, item) return dkp .. "dkp placés pour " .. item end;
    L["DEFAULT_AUCTION_WON_MESSAGE"] = function(dkp, item)
        return "GG ! Tu as gagné " .. item .. " pour " .. dkp ..
            "dkp !"
    end;
